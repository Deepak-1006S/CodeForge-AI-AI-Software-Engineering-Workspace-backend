...
import { Eye, EyeOff, Mail, Lock, User, Briefcase, Loader, CheckCircle2 } from 'lucide-react';
...
const registerSchema = z.object({
  ...
  role: z.enum(['Admin', 'Manager', 'Developer'] as const),
});
...
const passwordRequirements = [
  ...
  { label: 'One number', check: (pwd: string) => /\d/.test(pwd) },
];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-500 to-cyan-600 rounded-2xl mb-4 shadow-lg">
            <span className="text-2xl font-bold text-white">CF</span>
          </div>
          <h1 className="text-4xl font-bold text-white mb-2">CodeForge AI</h1>
          <p className="text-gray-400 text-sm">Join the AI-Powered Software Engineering Revolution</p>
        </div>

        {/* Register Card */}
        <div className="bg-slate-800 rounded-2xl shadow-2xl p-8 border border-slate-700 backdrop-blur">
          <h2 className="text-2xl font-bold text-white mb-1">Create your account</h2>
          <p className="text-gray-400 text-sm mb-6">Get started with CodeForge AI today</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  id="name"
                  className={`w-full pl-10 pr-4 py-3 rounded-lg bg-slate-700 border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 text-white placeholder-gray-500 ${
                    errors.name
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  id="password"
                  className={`w-full pl-10 pr-10 py-3 rounded-lg bg-slate-700 border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 text-white placeholder-gray-500 ${
                    errors.password
                      ? 'border-red-500 focus:ring-red-500'
                      : 'border-slate-600 hover:border-slate-500'
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                <Briefcase className="absolute left-3 top-3.5 w-5 h-5 text-gray-500 pointer-events-none" />
                <select
                  {...register('role')}
                  id="role"
                  className={`w-full pl-10 pr-4 py-3 rounded-lg bg-slate-700 border border-slate-600 hover:border-slate-500 focus:outline-none focus:ring-2 focus:ring-green-500 text-white transition-all duration-200 appearance-none cursor-pointer ${
                    errors.role
                      ? 'border-red-500 focus:ring-red-500'
                      : ''
                  }`}
